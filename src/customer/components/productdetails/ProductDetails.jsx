            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                    ...
                    <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">564 reviews</p>
                </div>
              </div>
        ...
        <section>
            ...
            <div className="border p-5">
                <Grid container spacing={7}>
                    ...
                    <Grid item xs={5}>
                        <h1 className="text-start text-1 font-semibold pb-1">Product Rating</h1>
                        <div className="flex items-center space-x-3">
                        ...
                        <Box className="mt-5 space-y-3">
                            ...
                            <Grid container alignItems={"center"} gap={2}>
                                ...
                                <Grid item xs={7}>
                                    <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius: 4,height:7}} variant="determinate" value={30} color="info"/>
                                </Grid>
                            </Grid>
                            <Grid container alignItems={"center"} gap={2}>
                                <Grid item xs={2}>
